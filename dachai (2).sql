...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2022 at 06:34 AM
...
(506, 'ยาต้านแบคทีเรีย'),
(507, 'ยาต้านเชื้อรา'),
(508, 'ยาระบบสืบพันธ์และทางเดินปัสสาวะ'),
(509, 'ยาใช้ภายนอก'),
(510, 'ยาควบคุมพิเศษ'),
(511, 'ยาคลายกล้ามเนื้อ'),
(512, 'ยากลุ่มโรคเรื้อรังที่ไม่ติดต่อ'),
(513, 'ยาหยอดตา ยาหยอดหู'),
(514, 'ฮอร์โมนและยาคุมกำเนิด'),
(515, 'ยาแผงบรรจุเสร็จ'),
(516, 'ยาถ่ายพยาธิ'),
(517, 'ยาครีมฆ่าเชื้อรา'),
(518, 'ยาปฏิชีวนะ'),
(519, 'เวชสำอางค์'),
(520, 'วิตามินและเกลือแร่'),
(521, 'วัสดุอุปกรณ์ทางการแพทย์'),
(523, 'ยาสามัญประจำบ้าน'),
(524, 'กลุ่มยาช่องคลอดและทวาร'),
(525, 'ยาระบบประสาทส่วนกลาง'),
(526, 'ผลิตภัณฑ์ทั่วไป');
...
INSERT INTO `employee` (`employee_id`, `username`, `password`, `employee_role`, `employee_img`, `employee_name`, `employee_email`, `employee_phone`) VALUES
(6778001, 'ei', '12345', 'เภสัชกร', NULL, '', '', ''),
(61122420, 'pluem', '12345', 'ผู้ดูแลระบบ', NULL, '', '', ''),
(61122421, 'aphiwat.j', '12345', '', 'logo.png', 'อภิวัฒน์ เจริญธรรม', 'aphiwat@gmail.co.th', '0645519578');
...
CREATE TABLE `good` (
  ...
  `good_create` varchar(255) NOT NULL,
  `po_buyer` varchar(255) NOT NULL,
  `good_status` varchar(255) DEFAULT NULL,
  `Lot_No` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `good` (`good_id`, `good_RefNo`, `good_create`, `po_buyer`, `good_status`, `Lot_No`) VALUES
(160, '1ymUPcV1FN', '2022-08-23', 'ei', '1', '');
...
CREATE TABLE `good_detail` (
  `good_detail_id` int(10) NOT NULL,
  `product_id` varchar(300) NOT NULL,
  `product_start_date` varchar(300) DEFAULT NULL,
  `product_end_date` varchar(300) DEFAULT NULL,
...
INSERT INTO `good_detail` (`good_detail_id`, `product_id`, `product_start_date`, `product_end_date`, `product_quantity`, `po_id`, `po_RefNo`, `product_total`, `good_id`) VALUES
(124, '138', NULL, NULL, '1', '140', 'PO-zgssjdtnx5tt', 321, '160');

-- --------------------------------------------------------

--
-- Table structure for table `history_cate`
--

CREATE TABLE `history_cate` (
  `History_cate_id` int(10) NOT NULL,
  `History_cate_old_name` varchar(300) NOT NULL,
  `category_id` varchar(300) NOT NULL,
  `History_cate_create` varchar(300) NOT NULL,
  `category_name` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `history_symp`
--

CREATE TABLE `history_symp` (
  `History_symp_id` int(255) NOT NULL,
  `History_symp_create` varchar(300) NOT NULL,
  `History_symp_old_name` varchar(300) NOT NULL,
  `symp_name` varchar(300) NOT NULL,
  `symp_id` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `history_type` (
  ...
  `History_type_old_name` varchar(300) NOT NULL,
  `type_id` varchar(300) NOT NULL,
  `History_type_create` varchar(300) NOT NULL,
...
--
-- Table structure for table `history_unit`
--

CREATE TABLE `history_unit` (
  `History_unit_id` int(10) NOT NULL,
  `History_unit_old_name` varchar(300) NOT NULL,
  `History_unit_create` varchar(300) NOT NULL,
...
(140, 'PO-zgssjdtnx5tt', '2022-08-23', 'ei', '', 'ได้รับสินค้า เข้าสต็อกแล้ว');
...
CREATE TABLE `po_detailproduct` (
  ...
  `product_quantity` varchar(300) NOT NULL,
  `product_id` varchar(300) NOT NULL,
  `product_start_date` varchar(255) DEFAULT NULL,
...
INSERT INTO `po_detailproduct` (`po_detailproid`, `product_quantity`, `product_id`, `product_start_date`, `product_end_date`, `product_total`, `po_id`) VALUES
(137, '1', '138', NULL, NULL, '321', '140');
...
CREATE TABLE `po_status` (
  ...
  `status_create` varchar(300) NOT NULL,
  `po_RefNo` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(138, 'สั่งซื้อสินค้าแล้ว รอใบรับสินค้า', '2022-08-23', 'PO-zgssjdtnx5tt');
...
CREATE TABLE `product` (
  ...
  `product_common` varchar(300) DEFAULT NULL,
...
(138, 'ไม้เท้าค้ำยัน', '', '6', '110', '506', '9', '1661273649023450_1.jpg', 'jE4xVLSrmP');
...
CREATE TABLE `product_date` (
  ...
  `product_create_date` varchar(300) NOT NULL,
  `product_id` varchar(255) NOT NULL,
  `good_RefNo` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(547, '2022-08-23', '2025-08-23', '2022-08-23', '138', '1ymUPcV1FN');
...
CREATE TABLE `product_price` (
  ...
  `product_price_sell` varchar(255) DEFAULT NULL,
  `product_id` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `product_quantity` (
  ...
  `product_quantity` varchar(300) DEFAULT NULL,
  `good_RefNo` varchar(255) DEFAULT NULL,
  `product_id` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `reorder` (`reorder_id`, `product_id`, `point`) VALUES
(26, '138', '10');
...
CREATE TABLE `sales` (
  ...
  `product_quantity` varchar(300) NOT NULL,
  `product_total` varchar(300) NOT NULL,
  `sales_change` varchar(300) DEFAULT NULL,
  `sales_create` varchar(300) NOT NULL,
  `product_id` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sales` (`sales_id`, `sales_RefNo`, `customer_id`, `sales_get`, `product_quantity`, `product_total`, `sales_change`, `sales_create`, `product_id`) VALUES
(61, 'EtKxljFAN6', NULL, '400', '1', '330', '46.89999999999998', '2022-08-23 , 23:56:15', '138');
...
(9, 'ระบบทางเดินหายใจ'),
(10, 'ยาตา หู คอ จมูก'),
(11, 'ยาระบบทางเดินอาหาร'),
(12, 'ยาโรคเรื้อรัง'),
(13, 'ยาต้านการติดเชื้อ'),
(14, 'ผลิตภัณฑ์สมุนไพร'),
(15, 'ผลิตภัณฑ์สุขภาพ'),
(16, 'ยาแก้ปวด ลดไข้ ลดอักเสบ'),
(17, 'ผลิตภัณฑ์เสริมอาหาร'),
(18, 'อุปกรณ์การแพทย์-ปฐมพยาบาล');
...
--
-- Stand-in structure for view `view_good_show`
-- (See below for the actual view)
--
CREATE TABLE `view_good_show` (
`good_id` int(10)
,`good_RefNo` varchar(300)
,`good_create` varchar(255)
,`po_buyer` varchar(255)
,`good_status` varchar(255)
,`product_id` varchar(300)
,`product_start_date` varchar(300)
,`product_end_date` varchar(300)
,`product_quantity` varchar(300)
,`po_id` varchar(255)
,`po_RefNo` varchar(300)
,`product_total` int(11)
);
...
--
-- Stand-in structure for view `view_partner_detail`
-- (See below for the actual view)
--
CREATE TABLE `view_partner_detail` (
`partner_id` int(13)
,`partner_name` varchar(300)
,`partner_phone` varchar(300)
,`partner_email` varchar(300)
...
,`partnerd_dis` int(30)
,`partnerd_amp` int(30)
,`name_pro` varchar(150)
,`name_amp` varchar(150)
,`name_dis` varchar(150)
,`zip_code` int(11)
);
...
--
-- Stand-in structure for view `view_po_show`
-- (See below for the actual view)
--
CREATE TABLE `view_po_show` (
`po_id` int(11)
,`po_RefNo` varchar(300)
,`po_Create` varchar(300)
,`po_buyer` varchar(300)
,`po_saler` varchar(300)
,`po_status` varchar(100)
,`product_start_date` varchar(255)
,`product_end_date` varchar(255)
,`product_quantity` varchar(300)
,`product_total` varchar(300)
,`product_id` varchar(300)
);
...
--
-- Stand-in structure for view `view_po_status`
-- (See below for the actual view)
--
CREATE TABLE `view_po_status` (
`po_id` int(11)
,`po_RefNo` varchar(300)
,`po_status` varchar(100)
,`status_create` varchar(300)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `view_product_date`
-- (See below for the actual view)
--
CREATE TABLE `view_product_date` (
`product_date_id` int(10)
,`product_start_date` varchar(300)
,`product_end_date` varchar(300)
,`good_RefNo` varchar(255)
...
--
-- Stand-in structure for view `view_product_price`
-- (See below for the actual view)
--
CREATE TABLE `view_product_price` (
`product_name` varchar(300)
,`product_price_id` int(10)
,`product_price_cost` varchar(300)
,`product_price_sell` varchar(255)
,`product_id` varchar(300)
);
...
--
-- Stand-in structure for view `view_product_quantity`
-- (See below for the actual view)
--
CREATE TABLE `view_product_quantity` (
`product_id` int(11)
,`product_name` varchar(300)
,`product_img` varchar(300)
,`product_quantity` varchar(300)
...
--
-- Stand-in structure for view `view_product_stock`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `view_product_stockv2`
-- (See below for the actual view)
--
CREATE TABLE `view_product_stockv2` (
`product_id` int(11)
,`product_name` varchar(300)
,`product_img` varchar(300)
,`product_quantity` varchar(300)
...
--
-- Stand-in structure for view `view_sales_detail`
-- (See below for the actual view)
--
CREATE TABLE `view_sales_detail` (
`sales_id` int(10)
,`sales_RefNo` varchar(300)
,`sales_get` varchar(300)
,`product_quantity` varchar(300)
,`product_total` varchar(300)
,`sales_change` varchar(300)
,`sales_create` varchar(300)
,`product_id` varchar(255)
,`product_name` varchar(300)
,`product_unit` varchar(300)
,`product_type` varchar(300)
...
--
-- Structure for view `view_good_show`
--
DROP TABLE IF EXISTS `view_good_show`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_good_show`  AS SELECT `a`.`good_id` AS `good_id`, `a`.`good_RefNo` AS `good_RefNo`, `a`.`good_create` AS `good_create`, `a`.`po_buyer` AS `po_buyer`, `a`.`good_status` AS `good_status`, `b`.`product_id` AS `product_id`, `b`.`product_start_date` AS `product_start_date`, `b`.`product_end_date` AS `product_end_date`, `b`.`product_quantity` AS `product_quantity`, `b`.`po_id` AS `po_id`, `b`.`po_RefNo` AS `po_RefNo`, `b`.`product_total` AS `product_total` FROM (`good` `a` join `good_detail` `b` on(`a`.`good_id` = `b`.`good_id`))  ;
...
--
-- Structure for view `view_partner_detail`
--
DROP TABLE IF EXISTS `view_partner_detail`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_partner_detail`  AS SELECT `a`.`partner_id` AS `partner_id`, `a`.`partner_name` AS `partner_name`, `a`.`partner_phone` AS `partner_phone`, `a`.`partner_email` AS `partner_email`, `aa`.`partnerd_add` AS `partnerd_add`, `aa`.`partnerd_pro` AS `partnerd_pro`, `aa`.`partnerd_dis` AS `partnerd_dis`, `aa`.`partnerd_amp` AS `partnerd_amp`, `b`.`name_th` AS `name_pro`, `c`.`name_th` AS `name_amp`, `d`.`name_th` AS `name_dis`, `d`.`zip_code` AS `zip_code` FROM ((((`partner` `a` join `partner_detail` `aa` on(`a`.`partner_id` = `aa`.`partner1_id`)) join `provinces` `b` on(`aa`.`partnerd_pro` = `b`.`id`)) join `amphures` `c` on(`aa`.`partnerd_amp` = `c`.`id`)) join `districts` `d` on(`aa`.`partnerd_dis` = `d`.`id`))  ;

-- --------------------------------------------------------

--
-- Structure for view `view_po_show`
--
DROP TABLE IF EXISTS `view_po_show`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_po_show`  AS SELECT `a`.`po_id` AS `po_id`, `a`.`po_RefNo` AS `po_RefNo`, `a`.`po_Create` AS `po_Create`, `a`.`po_buyer` AS `po_buyer`, `a`.`po_saler` AS `po_saler`, `a`.`po_status` AS `po_status`, `b`.`product_start_date` AS `product_start_date`, `b`.`product_end_date` AS `product_end_date`, `b`.`product_quantity` AS `product_quantity`, `b`.`product_total` AS `product_total`, `b`.`product_id` AS `product_id` FROM (`po` `a` join `po_detailproduct` `b` on(`a`.`po_id` = `b`.`po_id`))  ;

-- --------------------------------------------------------

--
-- Structure for view `view_po_status`
--
DROP TABLE IF EXISTS `view_po_status`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_po_status`  AS SELECT `a`.`po_id` AS `po_id`, `a`.`po_RefNo` AS `po_RefNo`, `a`.`po_status` AS `po_status`, `b`.`status_create` AS `status_create` FROM (`view_po_show` `a` join `po_status` `b` on(`a`.`po_RefNo` = `b`.`po_RefNo`))  ;

-- --------------------------------------------------------

--
-- Structure for view `view_product_date`
--
DROP TABLE IF EXISTS `view_product_date`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_date`  AS SELECT `a`.`product_date_id` AS `product_date_id`, `a`.`product_start_date` AS `product_start_date`, `a`.`product_end_date` AS `product_end_date`, `a`.`good_RefNo` AS `good_RefNo`, `a`.`product_id` AS `product_id`, `b`.`product_name` AS `product_name` FROM (`product_date` `a` join `product` `b` on(`a`.`product_id` = `b`.`product_id`))  ;
...
--
-- Structure for view `view_product_price`
--
DROP TABLE IF EXISTS `view_product_price`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_price`  AS SELECT `a`.`product_name` AS `product_name`, `b`.`product_price_id` AS `product_price_id`, `b`.`product_price_cost` AS `product_price_cost`, `b`.`product_price_sell` AS `product_price_sell`, `b`.`product_id` AS `product_id` FROM (`product` `a` join `product_price` `b` on(`a`.`product_id` = `b`.`product_id`))  ;

-- --------------------------------------------------------

--
-- Structure for view `view_product_quantity`
--
DROP TABLE IF EXISTS `view_product_quantity`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_quantity`  AS SELECT `a`.`product_id` AS `product_id`, `a`.`product_name` AS `product_name`, `a`.`product_img` AS `product_img`, `b`.`product_quantity` AS `product_quantity`, `b`.`good_RefNo` AS `good_Refno` FROM (`product_quantity` `b` left join `product` `a` on(`a`.`product_id` = `b`.`product_id`))  ;

-- --------------------------------------------------------

--
-- Structure for view `view_product_stock`
--
DROP TABLE IF EXISTS `view_product_stock`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_stock`  AS SELECT `aa`.`product_id` AS `product_id`, `aa`.`product_name` AS `product_name`, `aa`.`product_common` AS `product_common`, `aa`.`product_unit` AS `product_unit`, `aa`.`product_type` AS `product_type`, `aa`.`product_category` AS `product_category`, `aa`.`product_symp` AS `product_symp`, `aa`.`product_img` AS `product_img`, `aa`.`product_barcode` AS `product_barcode`, `aa`.`type_id` AS `type_id`, `aa`.`type_name` AS `type_name`, `aa`.`unit_id` AS `unit_id`, `aa`.`unit_name` AS `unit_name`, `aa`.`category_id` AS `category_id`, `aa`.`category_name` AS `category_name`, `aa`.`symp_id` AS `symp_id`, `aa`.`symp_name` AS `symp_name`, `a`.`product_quantity` AS `product_quantity`, `b`.`product_price_cost` AS `product_price_cost`, `b`.`product_price_sell` AS `product_price_sell`, `c`.`product_start_date` AS `product_start_date`, `c`.`product_end_date` AS `product_end_date`, `c`.`good_RefNo` AS `good_RefNo` FROM (((`view_product_detail` `aa` join `view_product_quantity` `a` on(`aa`.`product_id` = `a`.`product_id`)) join `view_product_price` `b` on(`a`.`product_id` = `b`.`product_id`)) join `view_product_date` `c` on(`a`.`product_id` = `c`.`product_id`)) WHERE `b`.`product_price_cost` <> 0 AND `c`.`product_start_date` <> 0 AND `c`.`product_end_date` is not null AND `a`.`good_Refno` is not nullnot null  ;

-- --------------------------------------------------------

--
-- Structure for view `view_product_stockv2`
--
DROP TABLE IF EXISTS `view_product_stockv2`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_stockv2`  AS SELECT `a`.`product_id` AS `product_id`, `a`.`product_name` AS `product_name`, `a`.`product_img` AS `product_img`, `a`.`product_quantity` AS `product_quantity`, `a`.`good_Refno` AS `good_Refno`, `b`.`product_price_cost` AS `product_price_cost`, `b`.`product_price_sell` AS `product_price_sell`, `c`.`type_name` AS `type_name`, `c`.`unit_name` AS `unit_name`, `c`.`category_name` AS `category_name`, `c`.`symp_name` AS `symp_name`, `d`.`product_start_date` AS `product_start_date`, `d`.`product_end_date` AS `product_end_date` FROM (((`view_product_quantity` `a` left join `view_product_price` `b` on(`a`.`product_id` = `b`.`product_id`)) left join `view_product_detail` `c` on(`a`.`product_id` = `b`.`product_id`)) left join `view_product_date` `d` on(`a`.`product_id` = `d`.`product_id`)) WHERE `b`.`product_price_cost` <> 0 AND `d`.`product_start_date` <> 0 AND `d`.`product_end_date` is not null AND `a`.`good_Refno` is not nullnot null  ;

-- --------------------------------------------------------

--
-- Structure for view `view_sales_detail`
--
DROP TABLE IF EXISTS `view_sales_detail`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_sales_detail`  AS SELECT `a`.`sales_id` AS `sales_id`, `a`.`sales_RefNo` AS `sales_RefNo`, `a`.`sales_get` AS `sales_get`, `a`.`product_quantity` AS `product_quantity`, `a`.`product_total` AS `product_total`, `a`.`sales_change` AS `sales_change`, `a`.`sales_create` AS `sales_create`, `a`.`product_id` AS `product_id`, `b`.`product_name` AS `product_name`, `b`.`product_unit` AS `product_unit`, `b`.`product_type` AS `product_type`, `b`.`product_category` AS `product_category`, `b`.`product_symp` AS `product_symp`, `b`.`product_img` AS `product_img`, `b`.`product_barcode` AS `product_barcode`, `b`.`type_id` AS `type_id`, `b`.`type_name` AS `type_name`, `b`.`unit_id` AS `unit_id`, `b`.`unit_name` AS `unit_name`, `b`.`category_id` AS `category_id`, `b`.`category_name` AS `category_name`, `b`.`symp_id` AS `symp_id`, `b`.`symp_name` AS `symp_name` FROM (`sales` `a` join `view_product_detail` `b` on(`a`.`product_id` = `b`.`product_id`))  ;
...
--
-- Indexes for table `good_detail`
--
ALTER TABLE `good_detail`
  ADD PRIMARY KEY (`good_detail_id`);

--
-- Indexes for table `history_cate`
--
ALTER TABLE `history_cate`
  ADD PRIMARY KEY (`History_cate_id`);

--
-- Indexes for table `history_symp`
--
ALTER TABLE `history_symp`
  ADD PRIMARY KEY (`History_symp_id`);
...
--
-- Indexes for table `history_unit`
--
ALTER TABLE `history_unit`
  ADD PRIMARY KEY (`History_unit_id`);
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=529;
...
--
ALTER TABLE `customer_detail`
  MODIFY `customerd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `employee_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61122422;
...
--
ALTER TABLE `good`
  MODIFY `good_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT for table `good_detail`
--
ALTER TABLE `good_detail`
  MODIFY `good_detail_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `history_cate`
--
ALTER TABLE `history_cate`
  MODIFY `History_cate_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `history_symp`
--
ALTER TABLE `history_symp`
  MODIFY `History_symp_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `history_type`
--
ALTER TABLE `history_type`
  MODIFY `History_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `history_unit`
--
ALTER TABLE `history_unit`
  MODIFY `History_unit_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `partner`
--
ALTER TABLE `partner`
  MODIFY `partner_id` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `partner_detail`
--
ALTER TABLE `partner_detail`
  MODIFY `partnerd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `po`
--
ALTER TABLE `po`
  MODIFY `po_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;

--
-- AUTO_INCREMENT for table `po_detailproduct`
--
ALTER TABLE `po_detailproduct`
  MODIFY `po_detailproid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;

--
-- AUTO_INCREMENT for table `po_status`
--
ALTER TABLE `po_status`
  MODIFY `po_status_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
ALTER TABLE `product_date`
  MODIFY `product_date_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=548;

--
-- AUTO_INCREMENT for table `product_price`
--
ALTER TABLE `product_price`
  MODIFY `product_price_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;

--
-- AUTO_INCREMENT for table `product_quantity`
--
ALTER TABLE `product_quantity`
  MODIFY `product_quantity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1068;
...
--
ALTER TABLE `reorder`
  MODIFY `reorder_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `sales`
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `sympton`
--
ALTER TABLE `sympton`
  MODIFY `symp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `type_product`
--
ALTER TABLE `type_product`
  MODIFY `type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
